...
void main() {
  ...
  group('Offline Workflow Integration Tests', () {
    test(
      'Workflow 1: Offline mode toggle -> route calculation with fallbacks',
      () async {
        // 1. Start Online
        ...
        expect(
          await mockConnectivityService.currentStatus,
          ConnectivityStatus.online,
        );
        ...
        expect(
          result.accuracy,
          equals(offlineModeService.currentAccuracyLevel),
        );
      },
    );

    test(
      'Workflow 2: Online -> offline transition during route calculation',
      () async {
        // 1. Start Online
        mockConnectivityService.setConnectivityStatus(
          ConnectivityStatus.online,
    ...
    test(
      'Workflow 3: Offline -> online transition with cache updates',
      () async {
        // 1. Start Offline
        mockConnectivityService.setConnectivityStatus(
