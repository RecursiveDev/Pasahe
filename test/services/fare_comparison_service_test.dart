...
void main() {
  ...
  group('FareComparisonService', () {
    ...
    test('recommendModes returns correct modes for medium distance (5km - 20km)', () {
    ...
    test('recommendModes returns correct modes for long distance (>= 20km)', () {
    ...
    test('recommendModes does not add Train/Ferry for non-Metro Manila (default assumption)', () {
