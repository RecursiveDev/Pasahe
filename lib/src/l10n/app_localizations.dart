...
abstract class AppLocalizations {
  ...
  /// No description provided for @calculateFareButton.
  ///
  /// In en, this message translates to:
  /// **'Calculate Fare'**
  String get calculateFareButton;

  /// No description provided for @saveRouteButton.
  ///
  /// In en, this message translates to:
  /// **'Save Route'**
  String get saveRouteButton;

  /// No description provided for @routeSavedMessage.
  ///
  /// In en, this message translates to:
  /// **'Route saved to offline history!'**
  ...
  /// No description provided for @provincialModeTitle.
  ///
  /// In en, this message translates to:
  /// **'Provincial Mode'**
  String get provincialModeTitle;

  /// No description provided for @provincialModeSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// In en, this message translates to:
  /// **'Traffic Factor'**
  String get trafficFactorTitle;

  /// No description provided for @trafficFactorSubtitle.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @trafficLowSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Light traffic'**
  String get trafficLowSubtitle;
  ...
  /// No description provided for @trafficMediumSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Moderate traffic'**
  String get trafficMediumSubtitle;
  ...
  /// No description provided for @trafficHighSubtitle.
  ///
  /// In en, this message translates to:
  /// **'Heavy traffic'**
